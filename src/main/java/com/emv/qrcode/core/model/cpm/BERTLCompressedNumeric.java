...
/**
 * Represents a BER-TLV element with a compressed numeric (hex-encoded) value.
 * This class is used for Consumer Presented Mode (CPM) QR code data fields that contain compressed numeric data.
 * The hex string is padded with a trailing "F" if the length is odd.
 *
 * @see BERTLV
 */
public class BERTLCompressedNumeric extends BERTLV {
  ...
  /**
   * Constructs a BERTLCompressedNumeric with the specified tag and byte array value.
   *
  ...
  /**
   * Constructs a BERTLCompressedNumeric with the specified tag bytes and byte array value.
   *
  ...
  /**
   * Constructs a BERTLCompressedNumeric with the specified tag bytes and hex string value.
   * The hex string is decoded to bytes (padded with trailing "F" if odd length).
   *
   * @param tag the tag as a byte array
  ...
  /**
   * Constructs a BERTLCompressedNumeric with the specified tag and hex string value.
   * The hex string is decoded to bytes (padded with trailing "F" if odd length).
   *
   * @param tag the BER tag
   * @param value the hex string value (will be decoded to bytes)
  ...
  /**
   * Sets the value as a hex string. The hex string is decoded to bytes (padded with trailing "F" if odd length).
   *
  ...
  /**
   * Converts a hex string to a byte array. Pads with trailing "F" if the string has odd length.
   *

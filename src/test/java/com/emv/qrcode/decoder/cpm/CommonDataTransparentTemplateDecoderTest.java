...
public class CommonDataTransparentTemplateDecoderTest {
  ...
  public void testSuccessDecode() throws PresentedModeException, IOException, DecoderException {
    ...
    final DuplicateTagException duplicateTagException = catchThrowableOfType(DuplicateTagException.class, () -> DecoderCpm.decode(source3, CommonDataTransparentTemplate.class));

...
public class ApplicationTemplateDecoderTest {
  ...
  public void testSuccessDecode() throws PresentedModeException, IOException, DecoderException {
    ...
    final DuplicateTagException duplicateTagException = catchThrowableOfType(DuplicateTagException.class, () -> DecoderCpm.decode(source3, ApplicationTemplate.class));

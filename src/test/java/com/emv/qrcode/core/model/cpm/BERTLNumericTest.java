...
public class BERTLNumericTest {
  ...
  public void testFail() throws IOException {
    final DecodeValueException decodeValueException = catchThrowableOfType(DecodeValueException.class, () -> new BERTLNumeric(TagTransactionProcessingCodes.ID_APPLICATION_PAN, "AG000000666666"));
